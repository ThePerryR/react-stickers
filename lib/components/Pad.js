...
var padTarget = {
  drop: function drop(props, monitor, component) {
    var move = monitor.getSourceClientOffset();
    ...
    if (props.options.useBoundary) {
      ...
      if (sticker.x + stickerItem.width > pad.offsetWidth) {
        sticker.x = pad.offsetWidth - stickerItem.width;
      }
      if (sticker.y + stickerItem.height > pad.offsetHeight) {
    ...
    value: function render() {
      ...
      return connectDropTarget(_react2.default.createElement(
        ...
        stickers.map(function (sticker, i) {
          return _react2.default.createElement(_DraggableSticker2.default, _extends({ key: i, index: i }, sticker, { options: options }));
        })
      ));
    }
  }]);
